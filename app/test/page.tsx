...
const steps: {
...
}[] = [
    {
        ...
        description: (
            <>
                Upstash offers a serverless Redis database with a generous free
                tier of up to 10,000 requests per day. Thats more than enough.
                <br />
                Click the button below to sign up and create a new Redis
                database on Upstash.
            </>
        ),
        cta: (
    ...
    },
    {
        ...
        description: (
            <p>
                After creating the database, scroll to the bottom and make a
                note of <code>UPSTASH_REDIS_REST_URL</code> and{" "}
                <code>UPSTASH_REDIS_REST_TOKEN</code>, you need them in the next
                step
            </p>
        ),
    },
    ...
    return (
        <div className="container px-8 mx-auto mt-16 lg:mt-32 ">
            ...
            <p className="mt-4 text-sm text-center text-zinc-600">
                You can deploy your own hosted version of EnvShare, you just
                need an Upstash and Vercel account.
            </p>
            <ol className="flex flex-col items-center justify-center mt-8 md:mt-16 xl:mt-24">
                {steps.map((step, stepIdx) => (
                    <li
                        key={step.name}
                        className="relative flex flex-col items-center gap-4 pb-16 group md:gap-8 md:pb-24"
                    >
                        <span
